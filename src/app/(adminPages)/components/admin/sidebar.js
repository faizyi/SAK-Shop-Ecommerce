...
const AdminSidebar = () => {
    ...
    return (
        <aside className={`${isOpenSidebar ? "" : "hidden sm:block"}
         fixed top-0 left-0 h-screen z-40 w-64 pt-20 p-5 transition-transform border-r border-gray-200 bg-slate-950 dark:border-gray-700`}>
