    ...
    lg:flex items-center justify-between">
      <div className="flex items-center space-x-4 text-sm">
        <div className="flex items-center">
          ...
          <p><strong className="mx-2">Address:</strong>Ahmed Market, Karachi, Pakistan</p>
        </div>
        <div className="flex items-center">
          <FaPhone className="text-blue-600" />
          <span><strong className="mx-2">Phone:</strong>+92 3002730249</span>
        </div>
        <div className="flex items-center">
          <FaWhatsapp className="text-green-600" />
          <span><strong className="mx-2">WhatsApp:</strong>+92 3002730249</span>
        </div>
        {/* <div className="flex items-center">
      ...
      <div className="flex items-center space-x-3">
        ...
        <a href="https://wa.me/+923002730249" target="_blank" rel="noopener noreferrer" 
